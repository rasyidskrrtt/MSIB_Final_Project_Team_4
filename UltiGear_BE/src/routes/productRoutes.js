...
productRoutes.post('/products', auth, authorization('ADMIN'), upload.single('image'), productControllers.createProduct);
...
productRoutes.put('/products/:id', auth, authorization('ADMIN'), upload.single('image'), productControllers.updateProduct);
